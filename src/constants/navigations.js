    ...
    [LANGUAGES_CODES.ES]: [
      {
        ...
        links: [
          ...
          },
          {
            title: 'link de pagos',
            links: [
              { title: 'Introducción', href: 'payments/payments-links' },
              { title: 'Funcionalidades', href: 'payments/payments-links/functionality' },
              { title: 'Accesos', href: 'payments/payments-links/access' },
              { title: 'Cómo ingresar', href: 'payments/payments-links/how_enter' },
              { title: 'Crear link de pagos', href: 'payments/payments-links/create_payment_link' },
              { title: 'Ingresar al módulo', href: 'payments/payments-links/enter_module' },
              { title: 'Formulario de pago', href: 'payments/payments-links/payment_form' },
              { title: 'Gestionar link de pagos', href: 'payments/payments-links/link_management' },
              { title: 'Destalle de un link de pago', href: 'payments/payments-links/payment_link_detail' },
              { title: 'Compartir', href: 'payments/payments-links/share' },
              { title: 'Pagos Relacionados', href: 'payments/payments-links/related_payment' },
              { title: 'Buscar links de pago', href: 'payments/payments-links/search' },
              { title: 'Proceso de pago', href: 'payments/payments-links/process_pay' },
              { title: 'Email', href: 'payments/payments-links/email' },
              { title: 'Vista de pago', href: 'payments/payments-links/payment_view' },
              { title: 'Proceso Webcheckout', href: 'payments/payments-links/process_webcheckout' },
            ],
          },
          {
