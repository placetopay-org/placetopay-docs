...
const TEXTS = {
  es: { label: 'Copiar JSON', copied: '¡Copiado!' },
  en: { label: 'Copy JSON', copied: 'Copied!' },
}

export const CopyJSON = ({ content, variant, className }) => {
  ...
  return (
    ...
    >
      {copied ? (
        ...
        <ClipboardIcon className="h-3.5 w-3.5 stroke-current" />
      )}
