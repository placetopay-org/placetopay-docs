    ...
    return (
        <SequenceDiagram customView={{ height: 1200, x: 70, y: 27.2727 }}>
            ...
            <SequenceAction
                ...
                from="actor"
                to="integrador"
                message="Seleccionar <br> tarjeta inscrita (Token)"
                positionX={100}
                positionY={170}
            />
            ...
            <SequenceAction
                ...
                from="tokenRequestor"
                to="tokenRequestor"
                message="Validar que el comercio esté activo"
                positionX={550}
                positionY={500}
                sourcePositionY={350}
                targetPositionY={650}
            ...
            <SequenceAction
                ...
                from="tokenRequestor"
                to="tokenRequestor"
                message="Validar que el token le pertenece <br> y está activo con la marca"
                positionX={550}
                positionY={650}
                sourcePositionY={500}
                targetPositionY={790}
            ...
            <SequenceAction
                ...
                from="integrador"
                to="integrador"
                message="Realizar acción con <br> el criptograma generado"
                positionX={310}
                positionY={1250}
            ...
            <SequenceAction
                ...
                from="integrador"
                to="actor"
                message="Acción realizada <br> exitosamente"
                positionX={400 - 300}
                positionY={1400}
            />
        </SequenceDiagram>
