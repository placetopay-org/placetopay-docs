...
return (
        <SequenceDiagram customView={{ height: 1200, x: 70, y: 27.2727 }}>
                ...
                <SequenceAction
                    ...
                    from="tokenRequestor"
                    to="tokenRequestor"
                    message="4. Validate that the token belongs to the requestor <br> and is active with the brand"
                    positionX="550"
                    positionY="650"
                    sourcePositionY="500"
                    targetPositionY="790"
                ...
                <SequenceAction
                    ...
                    from="integrator"
                    to="integrator"
                    message={`8. <span> Perform action with<br> <b> generated cryptogram </b> </span>`}
                    positionX="310"
                    positionY="1250"
