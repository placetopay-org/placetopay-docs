...
Para interactuar con la ***API de Invoice*** debe autenticar sus peticiones, de esta forma identificamos y validamos la información para que sus operaciones sean seguras.
La API utiliza Web Services Security Username Token Profile 1.1.

## Credenciales API

En la integración con **Invoice** usted debe contar con las credenciales login y secretKey de consumidor.
