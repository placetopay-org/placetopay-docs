...
Para interactuar con la ***API de gestion de ordenes de pago*** debe autenticar sus peticiones, de esta forma identificamos y validamos la información para que sus operaciones sean seguras.
