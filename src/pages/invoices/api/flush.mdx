...
## Eliminación masiva de facturas vencidas {{ id: 'flush-invoices', tag: 'POST', label: '/cash/invoice/flush' }}
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Eliminar facturas vencidas" tag="POST" label="/cash/invoice/flush">
