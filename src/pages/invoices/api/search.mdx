...
## Inscripción de búsqueda de factura {{ id: 'search-invoices', tag: 'POST', label: '/cash/invoice/search' }}
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Búsqueda de factura" tag="POST" label="/cash/invoice/search">
