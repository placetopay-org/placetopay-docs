...
<Row>
    ...
    <Col sticky>
        ...
        REF001,123456789,221571415,CCD,Nombre,Apellido,6000000,cliente@example.com,Calle 1,Medellín,CO,ABCD1234567890
        ```
...
<Note>
    **NOTAS**
    - La columna `reference` debe ser única por registro para permitir la asociación correcta entre la información enviada y el resultado de la tokenización.
    - La columna `customerAccountNumber` permite, tanto en procesos internos como en procesos externos realizados en Puerto Rico (ya sea para el pago de servicios o a proveedores), identificar al titular de la transacción y relacionarlo en distintos reportes de conciliación.
</Note>
