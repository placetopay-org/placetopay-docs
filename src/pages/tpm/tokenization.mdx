export const title = 'Tokenización masiva'
export const description = 'Tokenización masiva segura de tarjetas y cuentas bancarias mediante cifrado PGP e integración SFTP.'
