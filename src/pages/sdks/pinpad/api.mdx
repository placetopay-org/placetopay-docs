...
export const title = 'Crear transacción'
export const description = 'API del SDK Pinpad para crear transacciones y generar pinblocks encriptados de forma segura.'
