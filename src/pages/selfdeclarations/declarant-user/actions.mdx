...
<Note>
    Es importante destacar que, para que un usuario declarante pueda registrarse, primero debe ser creado por un usuario administrador, quien además debe asociarlo a una empresa y vincularlo a al menos una declaración. De lo contrario, no podrá completar el registro exitosamente.
</Note>
