...
<Note>
    Es de resaltar que el administrador no podrá crear, anular, autorizar o pagar los impuestos que se declaren. El usuario administrador solo podrá visualizar y descargar declaraciones, según la configuración por defecto. La configuración podrá cambiarse para añadirle o quitarle permisos a los usuarios administradores.
</Note>
...
<Note>
   Los usuarios autorizados no podrán acceder al sistema hasta que sean asociados a una empresa y vinculados al menos a una declaración.
</Note>


### Restablecer contraseña
Esta opción estará disponible para todos los usuarios creados.declaración
...
### Editar
Esta acción permite modificar los datos con los que se creó inicialmente el usuario.declaración
> Cuando un usuario se bloquee por exceso de intentos en el ingreso de contraseña, por ejemplo, este se podrá desbloquear desde el campo estado del usuario.
...
<Note>
    El usuario debe quedar asociado al menos a una declaración para que pueda completar el registro y así poder ingresar al sistema.
</Note>
