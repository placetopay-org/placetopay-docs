export const description = 'Guía de acciones del administrador en autodeclaraciones: usuarios, empresas, seguridad y auditoría.'
...
<Note>
    Es de resaltar que el administrador no podrá crear, anular, autorizar o pagar los impuestos que se declaren. El usuario administrador solo podrá visualizar y descargar declaraciones.
</Note>
...
Una vez diligenciados los datos dar clic en **guardar** para crear el usuario.

<Note>
   Los usuarios autorizados no podrán acceder al sistema hasta que sean asociados a una empresa y vinculados al menos a una renta.
</Note>


### Restablecer contraseña
Esta opción estará disponible para todos los usuarios creados.
> Si se restablece la contraseña a un usuario que aún no se encuentra asociado a una empresa, este no podrá ingresar hasta que sea asociado.
...
<img src="/Selfdeclarations/Admin_user/bidders_reset_password_options.png"/>
...
<img src="/Selfdeclarations/Admin_user/bidders_show_options.png"/>

### Editar
Esta acción permite modificar los datos con los que se creó inicialmente el usuario.
> Cuando un usuario se bloquee, por ejemplo, debido a intentos fallidos al ingresar la contraseña, podrá ser desbloqueado desde el campo 'Estado' del usuario.

Se puede acceder dando click en la acción **editar (lápiz)**, que está en el campo **"Opciones"** de la tabla o listado.

<img src="/Selfdeclarations/Admin_user/bidders_edit_options.png"/>
...
<img src="/Selfdeclarations/Admin_user/bidders_delete_options.png"/>
...
<img src="/Selfdeclarations/Admin_user/companies_home.png"/>
...
- *Dos empresas no pueden tener dentro del sistema el mismo número y tipo de documento*
...
<img src="/Selfdeclarations/Admin_user/associate_user.png"/>

Se habilitará el formulario para agregar el usuario, desde el mismo formulario se puede definir la función o posición que tendrá el usuario dentro de la empresa. Ya sea revisor fiscal, contador público, entre otros. Además se podrá determinar si el usuario tiene o no permisos para autorizar las declaraciones de esa empresa.
...
<Note>
    El usuario debe quedar asociado al menos a una renta para que pueda completar el registro y así poder ingresar al sistema.
</Note>
...
Para más información sobre el registro del usuario, [ver la documentación del usuario declarante](/selfdeclarations/declarant-user/actions).
...
- **Registro de empresas:**
    ...
    - TELEPHONE: Teléfono
    - CLASSIFICATION: Tipo de contribuyente
    - ADDRESS: Dirección
    - CITY: Ciudad
    - STATE: Departamento
    - COUNTRY: País
...
<Note>
    El archivo debe ser un archivo de tipo: csv, txt, tsv.
</Note>
...
<img src="/Selfdeclarations/Admin_user/all_incomes_lists.png"/>
...
<img src="/Selfdeclarations/Admin_user/all_incomes_show_options.png"/>
...
- **Listado de pagos:** En esta pestaña se podrá ver el listado de pagos que se han realizado a la declaración.
    <img src="/Selfdeclarations/Admin_user/all_incomes_view_payments.png"/>
...
<img src="/Selfdeclarations/Admin_user/all_incomes_download_options.png"/>
...
<img src="/Selfdeclarations/Admin_user/parameterization.png"/>

### Ajustes general
Aquí se podrán configurar los parámetros generales, tales como:

- **Máximos intentos permitidos por token:** Este es el número de intentos que se tendrán para ingresar el código OPT enviado al correo electrónico del usuario.
- **Tiempo de vida del token (minutos):** Este es el tiempo que tendrá el token para ser utilizado, después de este tiempo el token caducará y no se podrá utilizar.
- **Tiempo de espera para crear nuevos tokens en caso de expiración (minutos):** Este es el tiempo que se esperará para crear un nuevo token en caso de que el anterior haya expirado.
- **Moneda:** Este es el tipo de moneda que se utilizará en el sistema.
...
- **Máximo número de errores permitidos durante el cargue de archivos planos:** Este es el número máximo de errores que se permitirán al cargar un archivo plano, si se supera este número el sistema no permitirá cargar el archivo.
...
- **Cantidad de contraseñas a recordar:** Este número de contraseñas son las que el sistema almacenará en la base de datos con el fin de que, al restablecer contraseña, no se utilice la misma contraseña utilizada anteriormente.
- **Condiciones de contraseña:** Estas son las condiciones que deben cumplir las contraseñas para que el sistema las admita.
- **Tiempo para la expiracion de la contraseña en días:** Al transcurrir este número de días se solicitará por seguridad cambio de contraseña a los usuarios.
- **Minutos para el bloqueo de sesión por inactividad:** Después de permanecer inactivo dentro del sistema por este tiempo estimado, el sistema cerrará la sesión automáticamente.
- **Minutos para auto-desbloquearse después de bloqueo automático:** El tiempo en el que un usuario bloqueado se desbloquea automáticamente.
...
- **Ver:**
    ...
    <img src="/Selfdeclarations/Admin_user/settings_incomes_show.png"/>
...
- **Editar:**
    Esta opción permite cambiar los datos básicos de los impuestos y su configuración, como puede ser: el cambio de estado, el número de autorizaciones, si tiene multicrédito, entre otros.

    Para editar un registro presionar **Editar**, en la columna de **"Opciones"** de la tabla o listado, se abrirá una pantalla en la que pueden ver y modificar campos, para guardar los cambios realizados dar clic en **Guardar**.
    <img src="/Selfdeclarations/Admin_user/settings_incomes_edit.png"/>

    En este módulo está disponible la opción de multicrédito para los impuestos o declaraciones. Al habilitar el campo **Multi-crédito** se generará un registro vacío en el cual se deben diligenciar los campos y posteriormente guardar los cambios.
    <img src="/Selfdeclarations/Admin_user/settings_incomes_options_edit_multicredit.png"/>

    Para añadir más de un concepto se debe dar clic en el botón **Agregar**, el cual habilitará otro registro. Al finalizar la edición se debe dar clic en el botón **Guardar** para aplicar los cambios.
...
- **Ver:**
    Para ver un registro se da clic en **Ver**, en la columna **"Opciones"** de la tabla o listado. Se abrirá una pantalla con varias pestañas. En la primera pestaña se podrá ver la información básica del usuario.
    <img src="/Selfdeclarations/Admin_user/security_users_options_view_users.png"/>

    En la segunda pestaña se le podrán asignar los roles y los permisos que tendrá el usuario.
...
- **Ver:**
    Esta acción permite visualizar más información del registro. Esta opción abrirá una pantalla con dos pestañas. En la primera pestaña se podrá ver la información detallada del registro.
    <img src="/Selfdeclarations/Admin_user/security_api_view_tab1.png"/>

    En la segunda pestaña podrás administrar los permisos que tendrá el usuario dentro del servicio web API. Al crear el usuario, no se le asignará ningún permiso por defecto; deberás agregarlos manualmente para que pueda realizar consumos a través de la API.
...
- **Ver:**
    Esta opción permite realizar las diferentes acciones. Para ver un registro se debe dar clic en la acción **Ver**, que está en la columna **"Opciones"** de la tabla o listado. Se abrirá una pantalla con varias pestañas:
        ...
        - En la segunda pestaña estarán disponibles las acciones para:
            ...
            <img src="/Selfdeclarations/Admin_user/security_roles_permissions_add_permission.png"/>
            ...
            <img src="/Selfdeclarations/Admin_user/security_roles_permissions_desactive_or_remove.png"/>
