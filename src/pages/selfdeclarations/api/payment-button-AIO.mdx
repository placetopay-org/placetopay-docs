...
export const description = 'API AIO para crear botones de pago integrados con empresa, usuarios y declaración en una sola solicitud.'
...
<Row>
  <Col>
   ...
   <Col sticky>
      ...
      <br />
      <CodeGroup title="Solicitud" tag="POST" label="/api/v1/income-request-aio">
      ```bash {{ title: 'cURL' }}
      curl --request POST \
  ...
  <Col sticky>
      ...
      <CodeGroup title="Respuesta">
          ```json {{ title: 'Respuesta correcta' }}
          {
                "status": "SUCCESS",
                "reason": 200,
                "message": "Petición guardada correctamente.",
