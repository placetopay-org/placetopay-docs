...
export const description = 'Consulta el estado y detalles de una declaración creada desde el método AIO.'
...
<Row>
    ...
    <Col sticky>
        <br />
        <CodeGroup title="Solicitud" tag="POST" label="/api/v1/information-request">
            ```bash {{ title: 'cURL' }}
            curl --request POST \
