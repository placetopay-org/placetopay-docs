...
<SequenceDiagram customView={{ height:"790px", x:90, y:27.2727 }}> 
  <SequenceActor name="actor" color="bg-sky-500" label="Actor" positionX="0" positionY="0" height="960px" />
  <SequenceActor name="merchant" label="Merchant" positionX="220" positionY="0" height="960px" />
  <SequenceActor name="api_scudo" color="bg-orange-500" label="API Scudo" positionX="550" positionY="0" height="960px" />
  <SequenceAction 
    name="action1"
    from="actor" 
    to="merchant" 
...
<SequenceDiagram customView={{ height:"800px", x:100, y:27.2727, zoom: 0.60 }}> 
  <SequenceActor name="actor" color="bg-sky-500" label="Actor" positionX="-60" positionY="0" height="1250px" />
  <SequenceActor name="merchant" label="Merchant" positionX="180" positionY="0" height="1250px" />
  <SequenceActor name="api_scudo" color="bg-orange-500" label="API Scudo" positionX="550" positionY="0" height="1250px" />
  <SequenceActor name="placetopay" color="bg-orange-500" label="Placetopay transactional security" positionX="750" positionY="0" height="1250px" />
  <SequenceAction 
    name="action1"
    from="actor" 
    to="merchant" 
