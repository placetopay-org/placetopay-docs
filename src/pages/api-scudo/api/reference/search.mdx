...
<Row>
    <Col>
        Este servicio permite la búsqueda de transacciones por referencia, moneda y monto, suele utilizarse en caso de pérdida de comunicación al crear una validacion.
        <ApiReader
    ...
    <Col sticky>
        <CodeGroup title="Solicitud" tag="GET" label="/api/v1/validations/search">
            ```bash {{ title: 'cURL' }}
                curl --request POST \
