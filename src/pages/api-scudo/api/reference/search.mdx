...
export const title = 'Búsqueda de validaciones'
export const description = 'Búsqueda de validaciones en SCUDO por referencia y monto.'

<ApiDownloads />

## Busqueda de Validaciones {{ id: 'validation-transaction', tag: 'POST', label: '/api/v1/validations/search' }}

<Row>
    <Col>
        Este servicio permite la búsqueda de transacciones por referencia, moneda y monto, suele utilizarse en caso de pérdida de comunicación al crear una validación.
        <ApiReader
    ...
    <Col sticky>
        <CodeGroup title="Solicitud" tag="POST" label="/api/v1/validations/search">
            ```bash {{ title: 'cURL' }}
                curl --request POST \
...
<Row>
    ...
    <Col sticky>
        ...
        <CodeGroup title="Respuesta">
            ...
            ```
            ```json {{ title: '402: Entidad no procesable' }}
            {
                "data": null,
                "status": {
                    "code": 1202,
