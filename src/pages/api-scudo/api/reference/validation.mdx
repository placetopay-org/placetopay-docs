...
export const title = 'Obtener Validación'
export const description = 'Consulta una validación de SCUDO por referencia.'

<ApiDownloads />

## Obtener Validación {{ id: 'validation-transaction', tag: 'GET', label: '/api/v1/validations/{scudo_reference}' }}

<Row>
    <Col>
        Este endpoint devuelve una validación de scudo
        <ApiReader
    ...
    <Col sticky>
        <CodeGroup title="Solicitud" tag="GET" label="/api/v1/validations/{scudo_reference}">
            ```bash {{ title: 'cURL' }}
                curl --request GET \
...
<Row>
    ...
    <Col sticky>
        ...
        <CodeGroup title="Respuesta">
            ...
            ```
            ```json {{ title: '404: Respuesta fallida' }}
            {
                "data": null,
                "status": {
                    "code": 1350,
