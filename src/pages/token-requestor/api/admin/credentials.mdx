...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Solicitud" tag="POST" label="/api/admin/credentials/create">
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Solicitud" tag="POST" label="/api/admin/credentials/show">
...
## Actualización de credential {{ id: 'token-requestor-api-admin-credentials-edit', tag: 'POST', label: '/api/admin/credentials/edit' }}
