        ...
        <CodeGroup title="Solicitud" tag="POST" label="/api/admin/merchants/index">
            ...
            -d '{
                ...
                "filters": {
                    "name": "ACME Corp",
                    "brand": "ACME Corp Brand",
                    "consumerId": "0197f9ea-0277-709b-b9cb-d690d0742c57",
                    "document": {
                        "type": "NIT",
                        "number": "1234567895"
                    },
    ...
    <Col sticky>
        ...
        <CodeGroup title="Respuesta">
            ```json {{ title: 'Respuesta Exitosa' }}
            {
                ...
                "links": {
                    "first": "https://token-requestor.placetopay.ws/api/admin/merchants/index?page=1",
                    "last": "https://token-requestor.placetopay.ws/api/admin/merchants/index?page=1",
                    "prev": null,
                    "next": null
                },
                "meta": {
                    ...
                    "from": 1,
                    "last_page": 1,
                    "path": "https://token-requestor.placetopay.ws/api/admin/merchants/index",
                    "per_page": 10,
                    "to": 1,
                    "total": 1
                },
