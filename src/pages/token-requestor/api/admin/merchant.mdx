...
export const title = 'Creación de comercio'
export const description = 'API Admin para gestionar comercios en Token Requestor con operaciones CRUD, autenticación y filtros de búsqueda.'
