...
1. **[Descripción General:](/three-d-s-server)** En esta sección, encontrará un resumen detallado del protocolo **3DS Server**, incluyendo su propósito, cómo funciona, y los beneficios que aporta a la seguridad de las transacciones en línea.

2. **[API:](/three-d-s-server/api)** Aquí es donde podrá acceder a toda la información técnica necesaria para la integración del protocolo **3DS Server** en sus sistemas. Esta sección está dirigida a desarrolladores y equipos técnicos que desean implementar rápidamente y de manera segura las funcionalidades.


## Redes Soportadas

3DSS Placetopay se encuentra certificado en las versiones **EMV® 3DS 2.2.0** en los siguientes programas:

|                           | EMV® 3DS 2.2.0 |
|---------------------------|----------------|
| Visa Secure               | **Soportado**  |
| Mastercard Identity Check | **Soportado**  |
| American Express SafeKey® | **Soportado**  |
| Discover ProtectBuy       | **Soportado**  |
| Diners ProtectBuy         | **Soportado**  |
| ELO (Brasil)              | **Soportado**  |
...
Actualmente, estamos en el proceso de obtener la certificación para **EMV® 3DS 2.3.1**, la cual esperamos completar a inicios del 2025.
