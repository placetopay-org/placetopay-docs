export const description = 'Componente 3DS Server: gestión de sesiones y autenticación 3D-Secure entre comercio y franquicia emisora.'
...
- Recopilar los datos necesarios para los mensajes de 3D-Secure.
