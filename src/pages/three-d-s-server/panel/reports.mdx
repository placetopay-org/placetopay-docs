...
> La creación de reportes se realiza desde el módulo de "Autenticaciones". Para obtener instrucciones detalladas sobre cómo crear estos reportes, consulte la sección [Autenticaciones](/three-d-s-server/panel/authentications).
