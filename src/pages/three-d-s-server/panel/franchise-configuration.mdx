export const description = 'Configuración y administración de franquicias en 3DSS: certificados, servidores de directorio y rangos de tarjeta.'
...
## ¿Cómo acceder a la gestión de franquicias de 3DSS?
...
# ¿Cómo crear una franquicia en 3DSS?
...
- **Certificado raíz,** Copie y pegue en este campo el bloque de texto correspondiente al certificado raíz.
...
También, la franquicia debe proporcionar información como el tipo de tarjetas que soportan, las clases y los bines aceptados, para proceder a realizar una creación exitosa de franquicia en 3DSS y que esta coincida con las especificaciones y requerimientos esperados en la aplicación.
...
El módulo de franquicias es uno de los más importantes en 3DSS y de su correcta configuración depende gran parte del buen funcionamiento de la aplicación y del procesamiento de las autenticaciones.
...
En esta sección se encuentran listados los rangos de tarjeta creados para el DS, se presentan los datos listados en una tabla con el rango inicial y final, las versiones que soportan cada rango para el ACS y el DS y en algunos casos encontrará información de indicadores de ACS.
  ...
  **Buscador de rangos,**
  ...
  > Los rangos de tarjeta para un servidor de directorio son previamente configurados y migrados a la aplicación de 3DSS por el equipo de soporte de Evertec Placetopay.
