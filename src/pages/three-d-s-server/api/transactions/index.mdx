...
export const description = 'Consulta información de transacciones autenticadas con 3DS Server.'
...
Ver más detalle en [Valores devueltos en la respuesta API](/three-d-s-server/api/transactions/values)
...
<Note>
    **Importante:** Vea con más detalle los [Valores devueltos en la respuesta API](/three-d-s-server/api/transactions/values)
</Note>
