...
consulte [Sesión transacción con Bridging Message Extension](/three-d-s-server/api/integration/session#sesion-transaccion-con-bridging-message-extension-bme)
