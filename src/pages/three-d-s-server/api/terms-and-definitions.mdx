...
• **Canal de dispositivo (deviceChannel)** = '03' / 'RI'
...
|-----------------------------------------|--------------------------|-----------|---------------|
| **(01)** Recurring Transaction          | Visa con DAF, Mastercard | SI        | NO            |
| **(02)** Installment Transaction        | Visa con DAF, Mastercard | SI        | NO            |
...
| **(81)** Unscheduled Credential-on-File | Visa con DAF             | SI        | NO            |
