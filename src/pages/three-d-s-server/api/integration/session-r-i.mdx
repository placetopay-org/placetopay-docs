export const description = 'Flujo 3RI (Merchant Initiated Transaction) en EMV3DS: información general y consideraciones para Visa y Mastercard.'
...
| `messageVersion`           | string | `2.2.0`, `2.3.1`                   | Versión del protocolo EMV® 3D-Secure.                   |
...
* **3RI**: Inicio recurrente de 3D-Secure.
