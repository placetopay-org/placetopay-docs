...
**deviceChannel:** 03 indica que el canal es RI
...
**threeRIInd:** 85/MASTERCARD_3RI_IS_FOR_AN_AGENT_PAYMENT_TRANSACTION indica que la transacción de tipo otros pagos
...
**threeRIInd:** 11/OTHER_PAYMENT indica que la transacción de tipo otro pago
...
**threeRIInd:** 11/OTHER_PAYMENT indica que la transacción de tipo otros pagos
