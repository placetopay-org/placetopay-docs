...
Las autenticaciones de **No Pago (NPA)** son transacciones que requieren autenticar al titular de la tarjeta, pero **no están asociadas a una operación de compra o movimiento de fondos.**

**Ejemplos:**
- Agregar una tarjeta de crédito a una billetera digital.
- Verificar la identidad del titular de la tarjeta sin realizar una transacción monetaria.

En este tipo de autenticación **no es necesario verificar fondos** en la cuenta.

### Campos requeridos:

**Autenticaciones que se harán por navegador:**
- **messageCategory:** NPA (02), indica que la transacción es de tipo No Pago.

- **deviceChannel:** BRW (02), Navegador, Si no se envía, la plataforma lo asignará por defecto.
...
- **threeDSChallengeInd:** CHALLENGE_REQUESTED_MANDATE (04) Solicita de forma obligatoria un desafío al ACS. Para NPA, se recomienda 04 en lugar de 03 para garantizar que el ACS realice el desafío y no pueda ignorarlo.
