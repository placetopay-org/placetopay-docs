...
<br />
## Eliminar una sucursal de un comercio {{ id: 'delete-a-merchant', tag: 'DELETE', label: '/api/v2/merchants/{merchantID}/branches/{branchID}' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <br />
    <CodeGroup title="Solicitud" tag="DELETE" label="/api/v2/merchants/{merchantID}/branches/{branchID}">
    ```bash {{ title: 'cURL' }}
