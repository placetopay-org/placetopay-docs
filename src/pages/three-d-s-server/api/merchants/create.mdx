...
## Consultar un comercio {{ id: 'show-a-merchant', tag: 'GET', label: '/v1/merchants/{merchantCode}/{acquirerBIN}' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <br />
    <CodeGroup title="Solicitud" tag="GET" label="/v1/merchants/{merchantCode}/{acquirerBIN}">
    ```bash {{ title: 'cURL' }}
