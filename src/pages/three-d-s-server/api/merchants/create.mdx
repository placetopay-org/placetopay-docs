...
<br />
## Eliminar un comercio {{ id: 'delete-a-merchant', tag: 'DELETE', label: '/api/v2/merchants/{merchantID}' }}

Para realizar la eliminación, el comercio y sus sucursales no deben tener transacciones asociadas. Si se cumple esta condición, se eliminarán el comercio, sus sucursales, las suscripciones del comercio y de las sucursales, así como los tokens asociados a ambos.
...
<Row>
  ...
  <Col sticky>
    ...
    <br />
    <CodeGroup title="Solicitud" tag="DELETE" label="/api/v2/merchants/{merchantID}">
    ```bash {{ title: 'cURL' }}
