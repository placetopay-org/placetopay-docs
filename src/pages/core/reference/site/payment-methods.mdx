...
export const title = 'Métodos de Pago del Sitio';
...
export const description = 'Gestiona los métodos de pago específicos de los sitios, incluyendo la creación, actualización, eliminación y búsqueda.';
