...
#### [API de procesamiento](/gateway/api-reference/processing-api)
#### [API de validador de cuentas](/gateway/api-reference/account-validator)
...
Revisa la sección de  [Tokenization](/gateway/api-reference/tokenization) de la API.
