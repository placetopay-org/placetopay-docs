...
Por ejemplo. Cliente A va pagar por el servicio X, el cliente tiene un número de cuenta en ese comercio, por lo tanto el comercio debe asignarle el **valor único** de la transacción a ser ejecutada en función del servicio específico que esta pagando en ese momento para ese número de cuenta.
