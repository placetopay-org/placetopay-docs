...
export const title = 'Consultar ordenes de pago'
export const description = 'Consulta y eliminación de órdenes de pago.'

<ApiDownloads />

## Consultar órdenes de pago {{ id: 'rest-cashorder-search-request', tag: 'POST', label: '/cash/orders' }}

<Row>
    <Col>
        Este servicio permite consultar órdenes de pago mediante los valores de referencia, total y moneda.
...
<Row>
    ...
    <Col sticky>
        <CodeGroup title="Solicitud" tag="POST" label="/cash/delete">
```bash {{ title: 'cURL' }}
