...
export const title = 'Introducción'
export const description = 'API Gateway de Account Validator para crear sesiones, consultar estados y validar cuentas.'
...
<Row>
    ...
    <CodeGroup title="Solicitud" tag="POST" label="/gateway/account-validator/session">
    ```bash {{ title: 'cURL' }}
...
<Row>
    ...
    <CodeGroup title="Solicitud" tag="POST" label="/gateway/account-validator/query">
    ```bash {{ title: 'cURL' }}
...
<Row>
  <Col>
   ...
   <Col sticky>
      <CodeGroup title="Solicitud" tag="POST" label="/gateway/account-validator/validate">
      ```bash {{ title: 'cURL' }}
