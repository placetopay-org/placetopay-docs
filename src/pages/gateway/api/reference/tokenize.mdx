...
export const title = 'Tokenización (tokenize)'
export const description = 'Tokenización de tarjetas y cuentas bancarias en Gateway, con consulta e invalidación de tokens.'
