export const description = 'Formatos de archivos para importar órdenes de pago y recaudos en Placetopay: Asobancaria 2001, CSV y UBL-Invoice.'
...
Campo | Nombre | Long | Tipo | Req | Valor | Descripción
---------|----------|----------|----------|----------|----------|----------
1 | Referencia principal del usuario | 48 | ALF | SI | | Es el código principal con el cual el documento a pagar es identificado en cada Empresa. Puede referirse al número de factura o al que designe la Empresa Originadora.
2 | Referencia secundaria del usuario | 30 | ALF | NO | |Es el código con el cual  el cliente es identificado en la Empresa.
3 | No. Identificación del cliente pagador | 16 | ALF | NO | | No. Identificación del cliente.
