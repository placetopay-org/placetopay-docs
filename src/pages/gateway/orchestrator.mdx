export const description = 'Selección automática de medio de pago por índice con reintento ante rechazos elegibles.'
...
El código de respuesta debe estar dentro de la lista de códigos que permiten un nuevo procesamiento.
