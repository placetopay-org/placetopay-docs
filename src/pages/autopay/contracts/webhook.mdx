...
export const description = 'Notificaciones webhook de AutoPay con validación de firma SHA-256.'
...
<Note>
  **Importante:**
  ...
  2. Aunque este endpoint pertenece a contratos y existe una [Autenticación de contratos](/autopay/contract-authentication), la integridad del mensaje debe validarse mediante la **Firma Digital** descrita a continuación.
</Note>
