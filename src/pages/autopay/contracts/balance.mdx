...
export const title = 'Consultar monto a cobrar'
export const description = 'Endpoint del comercio para informar a AutoPay el monto a cobrar en autopagos variables.'
