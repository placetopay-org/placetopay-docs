...
export const title = 'Confirmar / Asentar pago'
export const description = 'Endpoint del comercio para registrar la confirmación final de un pago aprobado por AutoPay.'
...
<Row>
    ...
    <Col sticky={true}>
        <CodeGroup title="Solicitud" tag="POST" label="/autopay/settlement">
