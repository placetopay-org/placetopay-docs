export const apiRefs = ['/api/edit']

## Actualizar un AutoPago {{ id: 'update-autopay', tag: 'POST', label: '/api/edit' }}
...
<Row>
    ...
    <Col sticky>
        <br />
        <CodeGroup title="Solicitud" tag="POST" label="/api/edit">
            ```bash {{ title: 'General' }}
            curl -X "POST" {{baseURl}}/api/edit \
