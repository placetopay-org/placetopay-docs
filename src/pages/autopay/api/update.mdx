export const apiRefs = ['/api/client/edit']

## Actualizar un AutoPago {{ id: 'update-autopay', tag: 'POST', label: '/api/client/edit' }}
...
<Row>
    ...
    <Col sticky>
        <br />
        <CodeGroup title="Solicitud" tag="POST" label="/api/client/edit">
            ```bash {{ title: 'General' }}
            curl -X "POST" {{baseURl}}/api/client/edit \
