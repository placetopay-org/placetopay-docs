    ...
    <Col sticky>
        ...
        <CodeGroup title="Solicitud" tag="POST" label="/api/create">
            ...
            -d '{
                ...
                "chargeTypes": ["STATEMENT_BALANCE"], || MINIMUM_PAYMENT
                "recurring": {
                    "periodicity": "M",
                    "interval": "1",
            ...
            ```
            ```bash {{ title: 'Totalmente configurable por el usuario' }}
            curl -X "POST" {{baseURl}}/api/create \
            -H "Content-Type: application/json" \
            -d '{
                "auth": {
                ...
                "reference": "RF-12345",
                "description": "Plan de suscripción mensual",
                "chargeTypes": ["STATEMENT_BALANCE", "MINIMUM_PAYMENT", "FIXED_MINIMUM", "FIXED_AMOUNT"],
                "expiration": "2025-07-15T00:00:00-05:00",
                "returnUrl": "https://dnetix.co/p2p/client",
                "ipAddress": "127.0.0.1",
                "userAgent": "PlacetoPay Sandbox"
