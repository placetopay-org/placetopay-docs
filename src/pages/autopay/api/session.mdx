...
<Note>
  Este endpoint unificado gestiona tanto la creación (`CREATE`) como la edición (`EDIT`) de autopagos.
</Note>
...
### Detalles del Objeto Recurring
Para una configuración exitosa, consulta la guía de [Reglas de Recurrencia](/autopay/recurring-setup) para entender los valores permitidos en `periodicity` e `interval`.