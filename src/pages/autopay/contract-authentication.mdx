...
- **username:** Usuario que el comercio implementador debe **proveer a AutoPay** durante la configuración del sitio.
- **password:** Contraseña que el comercio implementador debe **proveer a AutoPay** durante la configuración del sitio.
...
**username:** Usuario que configuraste para que AutoPay consuma tus contratos.

**password:** Contraseña que configuraste para que AutoPay consuma tus contratos.
