...
Dado que AutoPay enviará peticiones a tu servidor (Webhooks, Balance, Settlement), necesitas un mecanismo para asegurarte de que **realmente somos nosotros** y no un atacante.
