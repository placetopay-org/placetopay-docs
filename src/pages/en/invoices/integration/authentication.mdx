...
To interact with the ***Invoice API*** you must authenticate your requests. This allows us to identify and validate the information to ensure your operations are secure.
The API uses Web Services Security Username Token Profile 1.1.

## API Credentials

When integrating with **Invoice**, you must have the consumer credentials: `login` and `secretKey`.
