...
## Bulk deletion of expired invoices {{ id: 'flush-invoices', tag: 'POST', label: '/cash/invoice/flush' }}
...
<Row>
  ...
  <Col sticky>
    <br />
   <CodeGroup title="Delete expired invoices" tag="POST" label="/cash/invoice/flush">
