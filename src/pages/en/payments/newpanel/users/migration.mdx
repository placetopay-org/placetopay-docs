...
<Note type="error"> If you want to change the authentication method, you can click on the “Choose another verification method” option before confirming the selected method. </Note>
...
<Note> This option applies only when the Authentication App method is selected. </Note>
