...
Below is the information corresponding to two-factor authentication, which must be completed in order to access the Dash, by following these steps:
...
Once authorization is complete, open the **Dash** corresponding to the user created, displaying the initial Dashboard.  
