...
export const description = "The following documentation provides a comprehensive guide on how to use our new administrative panel with exports and transactional statistics."
...
Depending on the criteria defined and the volume of information to be consulted, the system may take some time to prepare the export. Please wait until the status is displayed as **Successful**.
...
When you click on the **Create** button, a screen should appear with the basic section, which has the **Entity** field that allows you to select the source of the information for the export from a drop-down list. When you select the Entity, the **Export Type** field appears, in which you must select **Custom Export**.  
