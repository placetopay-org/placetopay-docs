...
- The transaction remains in state **pending** until a **Checkout** is performed.
- The `preAuthorization` node in the response stores critical data for later operations.

## Reauthorization

**Reauthorization** allows the merchant to adjust (increase) the amount of the original hold before the final capture.
