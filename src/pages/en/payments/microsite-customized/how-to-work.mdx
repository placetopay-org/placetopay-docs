...
export const description = 'Custom Microsite integration workflow: invoice inquiry, blocking, and settlement via external REST services.'
...
1. **Authentication:**  
   - Se soportan dos tipos de autenticación:  
     ...
     - For more information about this please go to the following section [Authentication](/en/payments/microsite-customized/authentication).   
...
2. **Invoice inquiries:**  
   ...
   - For more information about this please go to the following section [search](/en/payments/microsite-customized/services#busqueda-de-facturas).   
...
3. **Blocking and Release of Invoices:**  
   ...
   - For more information about this please go to the following section [hold](/en/payments/microsite-customized/services#bloqueo-y-liberacion-de-facturas).   
...
4. **Settlement of Payments:**  
   ...
   - For more information about this please go to the following section [settle](/en/payments/microsite-customized/services#asentamiento-de-factura).   
...
5. **Error Handling:**  
   ...
   - Error messages can be translated by language [Locale](/en/checkout/localization).  
   - For more information about this please go to the following section [error](/en/payments/microsite-customized/error-handling).   
...
6. **Payment Method Configuration:**  
   ...
   - For more information about this please go to the following section [paymentMethod](/en/payments/microsite-customized/data-structures#configuracion-de-metodos-de-pago).   
