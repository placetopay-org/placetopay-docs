...
## Amount
It is based on [AmountBase](/en/payments/microsite-customized/data-structures#amount-base) and details the total amount, including taxes and other items.
| name     | Type                     |  Description           |
|----------| ------------------------ |--------------------------------------------------------     |
| currency (Requerido)      | String  | Currency according to [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) (alphabetic code)      |
| total    (Requerido)      | Decimal | Total value       |
| taxes    (Requerido)      | [TaxDetail](/en/payments/microsite-customized/data-structures#tax-detail) | Description of taxes.       |
| details  (Requerido)      | [AmountDetail](/en/payments/microsite-customized/data-structures#amount-detail) | Description of total amount.       |

# Document Types 

The following documentation shows the types of documents accepted.[Documents Types](/en/checkout/document-types)