...
<CodeGroup title="Report generating">
...
2. In entity choose “Transactions” and in transaction type choose the “Export EBUS ACH Returns” option, which generates a specific ACH returns report.
3. Set the desired filters (such as date range, business, and test mode).
