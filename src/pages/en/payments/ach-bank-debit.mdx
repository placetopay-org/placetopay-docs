...
## Guide to Reviewing and Exporting ACH Returns
...
To generate the report, use the Request transaction report endpoint with the filter type: ["CHARGEBACK"] to get the return transactions.
...
Once the report is created, you can check it at the Get transaction report endpoint. This report includes differentiated transactions with the type field, indicating if the transaction was a “CHARGEBACK”.
