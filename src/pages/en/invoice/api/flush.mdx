...
## Bulk deletion of expired invoices {{ id: 'flush-invoices', tag: 'POST', label: '/flush' }}
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Request" tag="POST" label="/flush">
      ```json {{ 'title': 'Delete expired invoices' }}
      {
        "auth": {
