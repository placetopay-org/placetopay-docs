...
<Note>
Additionally the page that is displayed inside the lightbox does not need to install the library! Learn more in [Use without installation](#use-without-installation).
</Note>
