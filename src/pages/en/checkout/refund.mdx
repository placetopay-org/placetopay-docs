...
To process a refund, you need to make a request to the [Refund Transaction](/en/checkout/api/reference/payment/#transaction-actions) endpoint. Depending on the need, it is possible to make full refunds and partial refunds.
