...
- Control for `*.fields` properties in the session creation request `/api/session`.

## `2.19.0` 2023-11-15

### Changed:

- The `expiration` date in the response of the `Collect` endpoint is now presented in ISO 8601 format.
