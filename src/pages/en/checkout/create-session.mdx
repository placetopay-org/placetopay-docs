...
Para crear una sesión debes consumir nuestra API según tus necesidades, conoce los detalles del API en [API - Crear Sesion](/en/checkout/api-reference/session#create-a-session).

**Autenticación:** Para crear una sesión debes autenticarte con nuestra API, conoce los detalles en [Autenticación](/en/checkout/authentication)

**Localización:** Puedes elegir el idioma de la sesión haciendo uso de los parámetros del api, conoce los detalles en [Localización](/en/checkout/localization)
...
## Pago Recurrrente {{ id: 'recurring-payment' }}
...
El pago puede ser divido en diferentes convenios registrados, además permite que cada parte de la transacción sea procesada por diferentes proveedores.
