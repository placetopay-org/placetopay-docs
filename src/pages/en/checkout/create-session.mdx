...
Para crear una sesión debes consumir nuestra API según tus necesidades, conoce los detalles del API en [API - Crear Sesion](/en/checkout/api-reference/session#crear-una-sesion).
