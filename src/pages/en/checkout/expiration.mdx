...
<Note> 
Note: The `expiration` property is optional. If not provided, the system will automatically assign a default expiration time of **1 hour** from the session creation. 
</Note>
