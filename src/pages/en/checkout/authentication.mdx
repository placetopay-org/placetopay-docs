...
It is generated with the following formula `Base64(SHA-256(nonce + seed + secretKey))` this formula must be translated according to the programming language used.
