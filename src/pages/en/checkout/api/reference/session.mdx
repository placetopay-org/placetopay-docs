  ...
  -d '{
    ...
    "autopay": {
      ...
      "recurring": {
        ...
        "maxPeriods": 12,
        "dueDate": "2024-12-31",
        "notificationUrl": "https://merchant.example.com/autopay-notification"
      }
    },
    "returnUrl": "https://commerce.test/return",
    "ipAddress": "127.0.0.1",
...
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  ...
  -d '{
    ...
    "type": "autopay",
    "autopay": {
      "reference": "AUTOPAY_002",
      "description": "Credit card full balance payment",
      "dueDay": 10,
      "recurring": {
        "type": "TOTAL_BALANCE",
        "periodicity": "M",
...
```bash {{ title: 'Autopay session - Minimum Balance Plus Extra' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "auth": {
    ...
    "type": "autopay",
    "autopay": {
      "reference": "AUTOPAY_004",
      "description": "Credit card minimum payment plus extra amount",
      "amount": {
        "currency": "COP",
        "total": 25000
      },
...
```json {{ title: '200: Registered Autopay'}}
{
  ...
  "request": {
    ...
    "expiration": "2024-01-31T23:59:59-05:00",
    "returnUrl": "https://commerce.test/return",
    "ipAddress": "127.0.0.1",
    "userAgent": "PlacetoPay Sandbox"
  },
  "autopay": [
    {
      "status": {
        "status": "OK",
        "reason": "00",
        "message": "The autopay has been successfully registered",
        "date": "2022-07-27T14:51:27-05:00"
      },
