...
<Warning>This change does not apply to the production environment in Chile.. [Directory of environments](/en/checkout/test-your-integration#directory-of-environments)</Warning>
