...
- Endpoint [Information request](/checkout/api/reference/gateway-information) `/api/gateway/information`. Service that provides information about the user's `card` or `token` to be processed.
