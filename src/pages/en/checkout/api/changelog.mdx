...
Configuration for the maximum number of dispersions allowed for [dispersion payments](/en/checkout/create-session#dispersion-payment) in the `api/session` and `api/collect` endpoints. The default limit is 3 dispersions.
