...
Taxes are the levies that people or companies must pay to some entity or organization.
...
| Kind              | Translation        | Country            |
|-------------------|--------------------|--------------------|
| `valueAddedTax`   | IVA                | Global             |
| `exciseDuty`      | Tax                | Global             |
| `ice`             | ICE                | Global             |
| `airportTax`      | Airport tax | Colombia and Ecuador |
