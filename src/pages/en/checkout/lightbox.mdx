...
<Note>If you are using Webcheckout from a country other than Colombia, check the environment table in [Integration Testing](/en/checkout/test-your-integration) to verify the domains corresponding to your region.   
