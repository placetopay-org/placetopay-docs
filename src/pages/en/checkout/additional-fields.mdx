...
Structure that allows relating relevant information and controlling when it will be displayed in the collection process.
    ...
    <Col>
        <Properties>
            ...
            <Property name="displayOn" type="string" isRequired={false}>
                ...
                You can use this to decide if you want certain data to be seen during data capture, in the result of the process, in both stages, or never.<br/>
