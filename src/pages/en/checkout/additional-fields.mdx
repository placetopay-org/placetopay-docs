...
<Row>
<Col>
        If you need to send your customers' account identifier (whether for service payments or to providers) in the transaction to link it to the payment information, use the keyword CustomerAccountNumber.
</Col>
<Col sticky>
...
<Note>
The value sent with the keyword CustomerAccountNumber will be used in integrations (Azure Functions - Online Response and Azure Functions Get Balance) and in reports. It is crucial that the field is sent with the keyword CustomerAccountNumber. If another name is used, the value will not be processed correctly.
</Note>
