...
It is a configuration at the site level, necessary when a site has more than one payment method of the same brand (Visa and Mastercard), but with different providers and it is necessary to set the main acquirer.
