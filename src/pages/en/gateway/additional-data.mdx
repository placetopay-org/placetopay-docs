...
| `UNKNOWN_XX` | Installments whose interest condition must be resolved with provider subtype `XX` |
...
| `01` | `00` | `2` or more | `MERCHANT_WITHOUT_INTEREST` |
| `02` | `02` | `1` | `ISSUER_NOT_FEE` |
| `02` | `04` | `2` or more | `ISSUER_WITHOUT_INTEREST` |
| `02` | `00` | `2` or more | `ISSUER_UNKNOWN_00` |
| `02` | `01` | `2` or more | `ISSUER_UNKNOWN_01` |
| `02` | `03` | `2` or more | `ISSUER_UNKNOWN_03` |
| `03` | `00` | `2` or more | `ACQUIRER_UNKNOWN_00` |
| `04` | `00` | `2` or more | `AVERAGE_UNKNOWN_00` |

For `UNKNOWN_XX` credits in PAYSTUDIO `TS` flavour, use the interest service before processing when the final installment amount needs to be known. If the service cannot determine the applicable rate, the request may be rejected with reason `NR`.
