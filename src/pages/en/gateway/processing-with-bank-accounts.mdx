export const description = 'Processing payments with bank accounts in Gateway, with secure validation and tokenization.'
...
Check the section [Tokenization](/en/gateway/api/reference/tokenize) of the API.
