...
To enable the card return functionality, it is necessary to coordinate with our help desk or notify us during the initial phase of the integration process with the payment gateway.
