export const description = 'Decryption of PAN in transactions with AES/DES algorithms and PCI DSS certification requirement.'
...
<Note>The "PAN" field can be obtained in the response of [transaction processing](/en/gateway/api/reference/transaction) and in the [transaction query](/en/gateway/api/reference/transaction#query-request). This field is one of the properties available within [additional fields](/en/gateway/additional-data).</Note>
