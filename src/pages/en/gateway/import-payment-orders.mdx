export const description = 'File formats for importing payment orders and collections in Placetopay: Asobancaria 2001, CSV, and UBL-Invoice.'
...
Field | Name | Long | Type | Req | Value | Description
---------|----------|----------|----------|----------|----------|----------
1 | Primary User Reference | 48 | ALF | YES | | It is the main code with which the document to be paid is identified in each Company. It may refer to the invoice number or to the one designated by the Originating Company.
2 | Secondary user reference | 30 | ALF | NOT | |It is the code with which the client is identified in the Company.
3 | Paying client identification number | 16 | ALF | NOT | | Client identification number.
