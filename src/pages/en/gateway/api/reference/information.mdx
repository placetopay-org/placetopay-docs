...
<Row>
    <Col>
        This service should be consumed if the payment method requires it (requireBalance flag set to true in the information service response).
...
```json {{ title: '400' }}
    {
        "status": {
            "status": "REJECTED",
            "reason": "SU",
            "message": "The requested service does not apply to the payment method provided. Balance",
