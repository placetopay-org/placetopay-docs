...
## Get Balance (Only for Transerver) {{ id: 'balance-request', tag: 'POST', label: '/gateway/balance' }}

<Row>
    <Col>
        This service should be consumed if the payment method associated with Transerver requires it (requiresBalance set to true).
