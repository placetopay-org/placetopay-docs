...
export const title = 'Information request'
export const description = 'Query information, interests, and balance in the API Gateway.'
...
<Row>
    ...
    <Col sticky>
        ...
        ```json {{ title: 'Orchestrator' }}
            {
                "status": {
                    "status": "OK",
                    "reason": "00",
                    "message": "The request has been successfully processed",
                    "date": "2025-07-28T16:44:12-05:00"
                },
                "provider": "INTERDIN",
                "serviceCode": "ID_VS",
                "cardType": "C",
...
## Interest Calculation {{ id: 'interests-request', tag: 'POST', label: '/gateway/interests' }}
...
-d '{
    ...
    "payment": {
        ...
        "description": "Test with interest",
        "amount": {
            "currency": "CLP",
            "total": 50000
        }
