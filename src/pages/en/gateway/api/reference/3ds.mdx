    ...
    <Col sticky>
        <CodeGroup title="Solicitud" tag="POST" label="/gateway/mpi/lookup">
            ...
            ```bash {{ title: 'Version 2' }}
                ...
                "subscription": {
                    "reference": "311161",
                    "description": "Subscription 311161"
                },
                "returnUrl": "https://www.your-site.com/return?reference=1234567890",
            ...
            ```json {{ title: 'Version 2X' }}
            {
                ...
                "data": {
                    ...
                    "extra": {
                        ...
                        "acsTransId": "71dbbcfc-0cec-4683-b375-aeac87609b61",
                        "threeDSServerTransID": "c5a92daa-f198-4939-abed-8b0991cc5a4b",
                        "deviceChannel": "BRW",
                        "messageCategory": "NPA",
                        "authMethod": "CARDHOLDER_CHALLENGE_OCCURRED",
                        "authTimestamp": "2024-11-27T20:39:00+00:00",
                        "authInd": "ADD_CARD"
                    },
                    "validSignature": true
                }
