...
export const description = 'Account Validator API Gateway for creating sessions, checking statuses, and validating accounts.'
...
<Row>
    ...
    <CodeGroup title="Request" tag="POST" label="/gateway/account-validator/session">
    ```bash {{ title: 'cURL' }}
...
<Row>
    ...
    <CodeGroup title="Request" tag="POST" label="/gateway/account-validator/query">
    ```bash {{ title: 'cURL' }}
...
<Row>
  <Col>
   ...
   <Col sticky>
      <CodeGroup title="Request" tag="POST" label="/gateway/account-validator/validate">
      ```bash {{ title: 'cURL' }}
