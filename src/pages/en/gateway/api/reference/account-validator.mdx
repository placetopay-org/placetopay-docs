...
Se pueden consumir los siguientes endpoints de [Account Validator](/en/account-validator) garantizando mayor seguridad.

- [Crear una Sesión](/en/account-validator/api/session#create-a-session)
- [Consultar estado de sesión](/en/account-validator/api/session#check-session-status)
- [Validar Cuenta existente](/en/account-validator/api/validate-existing-account)
