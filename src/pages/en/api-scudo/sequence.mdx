...
<SequenceDiagram customView={{ height:750, x:100, y:27.2727, zoom: 0.55 }}> 
  ...
  <SequenceActor id="api_scudo" color="bg-orange-500" label="API Scudo" positionX="600" positionY="0" height="1250px" />
