...
export const title = 'Resolved Transaction Notification'
export const description = 'Webhook notification of manually resolved validations in SCUDO API.'

<ApiDownloads />

## [Webhook] Resolved Transaction Notification {{ id: 'notify-resolved-validation', tag: 'POST', label: '/notify-resolved-validation' }}

<Row>
    <Col>
        This endpoint must be implemented by the SCUDO API client to receive a notification of a validation with a manual action.
        <ApiReader
    ...
    <Col sticky>
        <CodeGroup title="Request" tag="POST" label="/notify-resolved-validation">
            ```bash {{ title: 'cURL' }}
            curl --request POST \
            ...
            --data '{
                "data": {
                    ...
                    "resolved": {
                        ...
                        "comments": "Client responds that it may be fraud",
