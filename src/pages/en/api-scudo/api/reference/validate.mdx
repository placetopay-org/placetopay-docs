...
export const title = 'Validate transaction'
export const description = 'Validation of transactions in SCUDO with risk rules and action response.'

<ApiDownloads />

## Validate transaction {{ id: 'validate-transaction', tag: 'POST', label: '/api/v1/validate' }}

<Row>
    <Col>
        This endpoint will validate a transaction according to the previously defined rules.
        <ApiReader
    ...
    <Col sticky>
        <CodeGroup title="Request" tag="POST" label="/api/v1/validate">
            ```bash {{ title: 'cURL' }}
                curl --request POST \
        ...
        <CodeGroup title="Response">
            ```json {{ title: '200: Successful response' }}
            {
              "status": {
                "code": 1200,
                "name": "successful",
                "message": "Transaction is successfully validated"
              },
              "data": {
                ...
                "rules": [
                  ...
                  {
                    "action": "continue_with_next_rule",
                    "name": "Number of cards by entity",
                    "rule_code": "number_of_transactions_by_card",
                    "type": "filter",
                    "response": {
                      "match": false,
                    ...
                    "response": {
                      ...
                      "service_response": {
                        ...
                        "fraudConcept": [
                          {
                            "code": "F22",
                            "description": "Fake companies - Unusual frequency of card-issuing country in merchant"
                          },
                          {
                            "code": "F23",
                            "description": "Data quality in the browser"
                          },
                          {
                            "code": "F24",
                            "description": "Data quality in operating system"
                          }
                        ],
                        "legalScore": 0.01,
                        "legalConcept": [
                          {
                            "code": "L11",
                            "description": "Trade section data quality"
                          },
                          {
                            "code": "L10",
                            "description": "Card data quality"
                          },
                          {
                            "code": "L1",
                            "description": "Similarity with payment history"
                          }
                        ],
                        "reliable": true,
                        "errorMessage": null
