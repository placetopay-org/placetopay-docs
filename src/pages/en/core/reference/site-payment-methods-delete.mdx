...
export const apiRefs = ['/core/site/payment-methods/delete']
export const description = 'En esta página, encontrarás información sobre la API Remover un medio de pago asociado a un sitio'
