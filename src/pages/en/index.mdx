...
<div className="not-prose grid grid-cols-1 gap-8 border-gray-900/5 dark:border-white/5 sm:grid-cols-2">
    ...
    />
     <ItemList
        name="ACS"
        description="(Access Control Server) component of the 3-D Secure protocol, belonging to the domain of the issuer, whose function is to authenticate a cardholder in a e-commerce transactions."
