export const description = 'Learn how to create, list, query, update, and delete Token Requestor sites in the admin API, including authentication requirements, request fields, validation rules, and response examples.'
