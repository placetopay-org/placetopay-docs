...
export const title = 'Creation of merchant'
export const description = 'Admin API to manage merchants in Token Requestor with CRUD operations, authentication, and search filters.'
