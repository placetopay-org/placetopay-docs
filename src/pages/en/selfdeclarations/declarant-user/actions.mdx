...
## Platform Login
Once registration is complete, two authentication options are presented:
...
## Profile
This will be the home screen after completing the system login registration. From here, you can view the user's basic information and the date the electronic key was downloaded, or alternatively, the button to download it.
...
### Revoke Electronic Key
This action allows a user to request the system administrator to reissue their electronic key. This reissue should only be requested in the event of loss or expiration.

<img src="/Selfdeclarations/Declarant_user/actions/my_profile_revoke.png"/>

To revoke the electronic key, press the red **Revoke Electronic Key** button. The user will then be asked for their password. Clicking **Confirm** will send a notification to the administrator user notifying them of the request. Depending on the case, the administrator will generate a new electronic key.
...
The file will appear in the download directory you have configured in your browser. When opened, depending on the declaration you have managed, it may look like this:
