export const description = 'Administrator actions guide in Selfdeclarations: users, companies, security, and auditing.'
...
For more information about user registration, [see the declarant user documentation](/en/selfdeclarations/declarant-user/actions).
