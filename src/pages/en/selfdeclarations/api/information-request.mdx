...
export const description = 'Retrieves the status and details of a declaration created from the AIO method.'
...
This API allows you to retrieve the status of a declaration created from the AIO method.
...
<Row>
    ...
    <Col sticky>
        <br />
        <CodeGroup title="Request" tag="POST" label="/api/v1/information-request">
            ```bash {{ title: 'cURL' }}
            curl --request POST \
        ...
        <CodeGroup title="Response">
            ```json {{ title: 'Full response' }}
            {
                ...
                "company": {
                    "documentType": "NIT",
                    "document": "6001903",
                    "legalName": "Commercial Company",
                    "commercialName": "TESTS COLLECTION"
                },
                "income": {
                    "status": "WITHOUT_PAY",
                    "signs": 1,
