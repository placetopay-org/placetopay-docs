...
export const description = 'AIO API to create payment buttons integrated with company, users, and declaration in a single request.'
...
<Row>
  <Col>
   ...
   <Col sticky>
      ...
      <br />
      <CodeGroup title="Request" tag="POST" label="/api/v1/income-request-aio">
      ```bash {{ title: 'cURL' }}
      curl --request POST \
