...
export const description = 'HTTP Basic Authentication for AutoPay contracts (Balance and Settlement).'
...
<Note>
  These credentials are configured during the Onboarding process [Service Activation](/en/autopay#service-activation).
</Note>
