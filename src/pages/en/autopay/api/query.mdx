...
export const title = 'Query an AutoPay session'
export const description = 'Query an AutoPay session and its transactions.'
...
<Note type="warning">
    ...
    For more information about the behavior, validations, and applicable contracts, refer to the official Checkout documentation at: [Query a Checkout session](/en/checkout/api/reference/session#query-a-session).
</Note>
