...
<Note type="warning">
    ...
    For more information about the behavior, validations, and applicable contracts, refer to the official Checkout documentation at: [Query a Checkout session](/checkout/api/reference/session/#query-a-session).
</Note>
