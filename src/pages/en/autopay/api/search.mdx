...
export const title = 'AutoPay Search'
export const description = 'Query and filter AutoPays with operational criteria and pagination.'
...
## AutoPay Search {{ id: 'search-autopay', tag: 'POST', label: '/autopay/search' }}
...
<Row>
    ...
    <Col sticky>
        <br />
        <CodeGroup title="Request" tag="POST" label="/autopay/search">
            ```bash {{ title: 'General' }}
