...
export const description = 'AutoPay API integration guide: base URL, headers, responses, and endpoints.'
...
| :--- | :--- | :--- |
| **Sandbox** | `https://api-test.placetopay.com` | Used for development and testing. It does not process real money. |
...
* [**Sessions**](/en/autopay/api/session): The entry point. Allows creating a new autopay or editing an existing one.
* [**Search**](/en/autopay/api/search): Query the status and details of your autopays.
* [**Transactions**](/en/autopay/api/transactions): Get the history of charges made on a specific autopay.
* [**Cancellation**](/en/autopay/api/cancel): Stop an autopay to prevent future charges.