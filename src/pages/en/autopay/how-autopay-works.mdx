...
👉 [**See Recurring configuration guide**](/en/autopay/recurring-setup)
...
👉 [**See Charge Types detail**](/en/autopay/charge-types)
...
* [Create an AutoPay Session](/en/autopay/api/session#create-a-session)
* [Implement client contracts](/en/autopay/contracts) (For variable charges)
* [AutoPay management](/en/autopay/api/session#query-a-session) (Query and cancellation)