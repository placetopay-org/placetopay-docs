...
export const title = 'Settle / Confirm Payment'
export const description = 'Merchant endpoint to register the final confirmation of a payment approved by AutoPay.'
