...
export const description = 'Guide to AutoPay charge types and their integration logic.'
...
<Note>
  **Technical Requirement:** To use `TOTAL_BALANCE` or `MINIMUM_BALANCE`, your server must expose the [Balance Query](/en/autopay/contracts/balance) endpoint so AutoPay can ask how much to charge.
</Note>