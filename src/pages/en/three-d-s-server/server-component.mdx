export const description = '3DS Server Component: session management and 3D-Secure authentication between the merchant and the issuing franchise.'
...
- Collecting the necessary data for 3D-Secure messages.
