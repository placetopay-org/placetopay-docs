export const title = 'General Terms'
export const description = 'Key definitions of the EMV 3D-Secure protocol: components, roles, messages, and authentication flows.'
