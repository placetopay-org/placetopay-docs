export const description = '3DS Server API documentation.'

# 3DS Server API

This document presents the operation of the 3DS Server service or API. It describes the endpoints to be used (**/sessions** and **/transactions**), the URL, method, parameters, and the data types it receives. In addition, it contains example responses for different types of requests in the cardholder authentication flow within the 3D-Secure protocol framework.

- Getting started with 3DS Server: [Session API Table](/en/three-d-s-server/api/sessions/rules)

### Invitation to Integrate with the 3D-Secure Protocol through our API
...
**Don't wait any longer to strengthen your security and improve your customers' experience. Start today** exploring the possibilities that our **3DS Evertec API** can offer you.
