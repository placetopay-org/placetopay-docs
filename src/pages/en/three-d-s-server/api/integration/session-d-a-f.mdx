export const description = 'Visa DAF integration for faster and more secure authentications in future transactions.'

# DAF: Digital Authentication Framework

Visa Digital Authentication Framework (DAF) is a message extension of the EMV® 3D-Secure protocol that allows Visa to identify cardholders who have completed the challenge authentication flow at a specific merchant-acquirer, thereby granting them a trusted status by determining them as an **authenticated credential payment**. This enables subsequent transactions performed by the cardholder at the same merchant to be authenticated immediately. The main goal is to reduce fraud and friction.
