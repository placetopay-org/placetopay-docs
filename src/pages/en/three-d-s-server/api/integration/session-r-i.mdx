export const description = '3RI (Merchant Initiated Transaction) flow in EMV 3DS: general information and considerations for Visa and Mastercard.'
...
[https://docs.placetopay.dev/three-d-s-server/api/integration/session-d-a-f](https://docs.placetopay.dev/three-d-s-server/api/integration/session-d-a-f)
...
We are pleased to invite you to visit the [Additional Data](/en/three-d-s-server/api/sessions/detail-info) section of our API documentation. This section provides crucial information for optimizing the 3DS authentication process.
