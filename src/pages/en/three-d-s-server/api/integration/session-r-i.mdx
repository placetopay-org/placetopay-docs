...
| `purchaseInstalData`       | string | > 1 y <= número de cuotas            | Total number of installments in the plan.        |
...
| `purchaseCurrency`         | string | ISO4217 código alpha. e.g., USD      | Transaction currency.                            |
