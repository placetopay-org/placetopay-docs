...
<Note>
    Para VISA está disponible el flujo de pago recurrente a través del [DAF](/en/three-d-s-server/api/integration/session-d-a-f), el cual es opcional
</Note>
...
<Note>
    Para VISA está disponible el flujo de pagos a plazo a través del [DAF](/en/three-d-s-server/api/integration/session-d-a-f)
</Note>
...
<Note>
    Para Visa está disponible el flujo de envío dividido a través del [DAF](/en/three-d-s-server/api/integration/session-d-a-f), el cual es opcional para el flujo de 3RI
</Note>
...
<Note>
    Además de tener en cuenta las configuraciones descritas en la documentación de [DAF](/en/three-d-s-server/api/integration/session-d-a-f)
</Note>
...
**Datos DAF:** las llaves adicionales que se deberán enviar para que se aplique el [DAF](/en/three-d-s-server/api/integration/session-d-a-f) con VISA son los siguientes
...
La implementación con [DAF](/en/three-d-s-server/api/integration/session-d-a-f) es opcional.
