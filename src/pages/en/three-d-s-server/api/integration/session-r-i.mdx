...
A través de ejemplos concretos, dando asi una comprensión más profunda de cómo implementar este servicio puede contribuir a una mayor protección contra fraudes y a la construcción de un entorno de confianza en el ámbito digital.
Ver más detalle en [Tipos de mensajes 3RI admitidos](/en/three-d-s-server/api/terms-and-definitions#tipos-de-mensajes-3-ri-admitidos)
...
**threeDSChallengeInd:** 04/CHALLENGE_REQUESTED_MANDATE: el desafío es obligatorio
...
**deviceChannel:** 03/RI indica que el canal es 3RI

**threeRIInd:** 01/RECURRING_TRANSACTION indica que la transacción es recurrente

**threeDSReqPriorAuthMethod:** Método que fue usado por el tarjetahabiente para la autenticación. 01/FRICTIONLESS_AUTHENTICATION sin fricción,
02/CARDHOLDER_CHALLENGE_OCCURRED con fricción, consultar la sesión Obtener los datos del threeDSRequestorPriorAuthenticationInfo
...
**threeDSReqPriorAuthMethod:** Método que fue usado por el tarjetahabiente para la autenticación. 01/FRICTIONLESS_AUTHENTICATION sin fricción, 02/CARDHOLDER_CHALLENGE_OCCURRED con fricción, consultar la sesión Obtener los datos del threeDSRequestorPriorAuthenticationInfo
...
**threeRIInd:** 02/INSTALMENT_TRANSACTION indica que la transacción es a plazos
...
**threeRIInd:** 06/SPLIT_OR_DELAYED_SHIPMENT indica que la transacción es un envío dividido o retrasado

**threeDSReqPriorAuthMethod:** Método que fue usado por el tarjetahabiente para la autenticación. 01/FRICTIONLESS_AUTHENTICATION sin fricción, 027CARDHOLDER_CHALLENGE_OCCURRED con fricción, consultar la sesión Obtener los datos del threeDSRequestorPriorAuthenticationInfo
