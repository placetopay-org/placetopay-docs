export const description = 'Additional data to improve 3DS Secure authentication: account, contact, risk, and prior authentication.'
...
For more information on using this extension to improve authentication rates with version 2.3.1, see [Session transaction with Bridging Message Extension](/en/three-d-s-server/api/integration/session-b-m-e).
