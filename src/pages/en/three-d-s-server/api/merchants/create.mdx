...
## Consult a merchant {{ id: 'show-a-merchant', tag: 'GET', label: '/api/v1/merchants/{merchantCode}/{acquirerBIN}' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <br />
    <CodeGroup title="Request" tag="GET" label="/api/v1/merchants/{merchantCode}/{acquirerBIN}">
    ```bash {{ title: 'cURL' }}
