...
<br />
## Delete branches to a merchant {{ id: 'delete-a-merchant', tag: 'DELETE', label: '/api/v2/merchants/{merchant}/branches/{branch}' }}
...
<Row>
  ...
  <Col sticky>
    ...
    <br />
    <CodeGroup title="Request" tag="DELETE" label="/api/v2/merchants/{merchant}/branches/{branch}">
    ```bash {{ title: 'cURL' }}
