...
## Add branches to a merchant {{ id: 'add-branches', tag: 'POST', label: '/v1/merchants/merchantID/branches' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/v1/merchants/{merchantID}/branches">
    ```bash {{ title: 'cURL' }}
