export const description = 'FAQ of 3D Secure Server: functionality, authentication, and security in online payments.'
...
The **3D-Secure Protocol** defines and outlines the infrastructure and guidelines for authenticating the cardholder during an e-commerce transaction.
