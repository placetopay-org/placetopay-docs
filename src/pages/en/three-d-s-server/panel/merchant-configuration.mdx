...
Se requiere que exista una relación entre emisor, adquiriente y comercio y que estos estén registrados en las aplicaciones de ACS y de 3DSS de Evertec Placetopay, para lograr un proceso de autenticación exitosa utilizando el protocolo 3-D Secure.
