...
export const description = 'Configuración del panel 3DSS: gestión de CIIU, adquirientes, certificados, contactos, códigos MCC y aliados.'
...
En esta sección se visualiza el índice o listado de los adquirientes registrados en 3DSS.
...
Para crear un nuevo certificado en 3DSS, haga clic en el botón **Crear** ubicado en la parte lateral derecha del índice de certificados.
...
En esta sección se visualiza el índice o listado de los tipos de contacto registrados en 3DSS.
...
<img src="/3DS_server/Mpi-contact-types-menu-2.png" alt="Contact-type-create" width="400"/>
...
En esta sección se visualiza el índice o listado de los consultores comerciales registrados en 3DSS.

Un ejemplo de este índice es el siguiente:

<img src="/3DS_server/Consultants.png" alt="Consultats" width="400"/>
...
En esta sección se visualiza el índice o listado de los aliados comerciales registrados en 3DSS.
...
El índice de aliados comerciales, tiene la funcionalidad del buscador, que está ubicado en la parte lateral izquierda y mediante el cual se puede hacer búsquedas por el nombre completo del aliado o fragmentos de este.
...
En esta sección se visualiza el índice o listado de los tipos de adjuntos registrados en 3DSS.
...
Para cambiar el idioma con el que se imprimen los datos y los menús de 3DSS, haga clic en el botón *English*, para el idioma inglés.
