...
export const description = 'Reportes de autenticaciones en 3DS Server: visualización, descarga y gestión en CSV/TSV.'
...
> La creación de reportes se realiza desde el módulo de "Autenticaciones". Para obtener instrucciones detalladas sobre cómo crear estos reportes, consulte la sección [Autenticaciones](/en/three-d-s-server/panel/authentications).
