...
export const description = 'In this section, you will find an overview of the 3DS Server component, including its purpose, how it works, and the benefits it brings to the security of online transactions.'
...
1. **[General Description:](/en/three-d-s-server)** In this section, you will find an overview of the **3DS Server** component, including its purpose, how it works, and the benefits it brings to the security of online transactions.

2. **[API:](/en/three-d-s-server/api)** Here you will find all the technical information necessary for integrating the **3DS Server** into your systems. This section is intended for developers and technical teams who want to quickly and securely implement the functionalities.
...
We invite you to explore our detailed [API Section](/en/three-d-s-server/api), where you’ll find all the technical information needed to quickly and securely integrate the **3DS Server Placetopay** service into your environment.
