...
Cada página de colección lo explica en detalle: [Integraciones](/en/onboarding/integrations), [Medios de pago](/en/onboarding/payment-methods), [Sitios](/en/onboarding/sites), [Integraciones del sitio](/en/onboarding/site-integrations) y [Medios de pago del sitio](/en/onboarding/site-payment-methods).
...
<Note>
  La única excepción es `sites[].id`, que **sí** viaja en el cuerpo: es lo que distingue el sitio que quieres modificar de uno nuevo. Ver [Sitios](/en/onboarding/sites).
</Note>
...
<Note>
  Un comercio puede desaparecer entre la aceptación y la ejecución. En ese caso el proceso termina en `FAILED` con `status.reason` en `RESOURCE_NOT_FOUND`. Ver [Errores](/en/onboarding/errors).
</Note>
...
- [Consultar un comercio](/en/onboarding/show-merchant) — leer el estado actual y los identificadores de sus colecciones
- [Datos del comercio](/en/onboarding/merchant-data)
- [Referencia de la API](/en/onboarding/api/reference/merchants#update-a-merchant) — el contrato completo, campo a campo
