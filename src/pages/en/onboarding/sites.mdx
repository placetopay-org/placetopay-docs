...
<Row>
  <Col>
    ...
    La fusión ocurre **por nombre de primer nivel, y el valor se reemplaza entero**: reenviar un objeto no lo combina con el que estaba guardado. Para retirar una cuota de un `installments_data`, reenvía el objeto sin ella.
  </Col>
  <Col sticky>
...
### Un documento completo, de una integración real {{ id: 'metadata-example' }}

[Ejemplo: el conector Copper](/en/onboarding/site-metadata-copper) muestra el `metadata` que envía una integración en producción, con su forma y sus estructuras anidadas, y la lista de nombres que ese conector reconoce. Es un ejemplo, no un vocabulario: los nombres que veas ahí los eligió ese comercio, y esta API no los conoce.
...
- [Ejemplo: el conector Copper](/en/onboarding/site-metadata-copper)
