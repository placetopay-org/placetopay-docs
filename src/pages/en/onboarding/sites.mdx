...
<Row>
  <Col>
    ...
    El valor de un nombre puede ser un escalar o una **estructura** — un objeto o una lista. Un escalar conserva el tipo con el que lo envías: un número sigue siendo número y un booleano, booleano.
  </Col>
  <Col sticky>
    ```json {{ title: 'metadata' }}
    {
...
Un **valor** es un escalar o una estructura. El anidamiento llega hasta **tres niveles**, y cada hoja escalar admite 1024 caracteres.
