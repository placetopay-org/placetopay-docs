export const title = 'How Account Validator works'
export const description = 'Learn how Account Validator works: prerequisites, session creation, user redirection, status querying, and ACH account validation.'
