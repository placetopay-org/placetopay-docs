...
export const title = 'Validate Existing Account';
export const description = 'On this page, you will find information about the Validate Existing Account API.'
...
<Row>
  <Col>
   ...
   <Col sticky>
      <CodeGroup title="Request" tag="POST" label="/api/validate-existing-account">
      ```bash {{ title: 'cURL' }}
