export const title = 'Event Webhook'
export const description = 'Account Validator webhook notifications with security signature and session status.'
