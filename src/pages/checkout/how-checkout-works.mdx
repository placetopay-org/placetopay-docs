...
import DiagramSequence from "@/components/react-flow/DiagramSequence"
...
<DiagramSequence> 
  <SequenceActor name="site" color="bg-sky-500" label="Tu sitio" positionX="-10" positionY="0" height="660px" />
  <SequenceActor name="server" label="Tu servidor" positionX="200" positionY="0" height="660px" />
  <SequenceActor name="webcheckout" color="bg-orange-500" label="Webcheckout" positionX="500" positionY="0" height="660px" />
  <SequenceAction 
    name="process"
    from="site" 
    to="server" 
