...
<DiagramSequence> 
  <SequenceActor name="test" label="Tu sitio"></SequenceActor>
  <SequenceActor name="test1" color="bg-sky-400" label="Tu servidor"></SequenceActor>
  <SequenceActor name="test2" color="bg-pink-500" label="Webcheckout"></SequenceActor>
</DiagramSequence>
