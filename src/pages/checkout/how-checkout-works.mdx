...
- **REJECTED:**   
Este estado puede presentarse cuando la sesión es rechazada por el usuario, lo que puede ocurrir cuando el usuario decide cancelar el pago. También puede ocurrir cuando la sesión expira debido a un tiempo límite, lo que significa que la transacción no se completó a tiempo.

- **PARTIAL EXPIRED:**   
Si una parte del pago ha sido aprobada, pero la sesión ha expirado antes de que este se complete. Este estado sólo se presenta en sesiones de tipo de pago parcial.
