...
<DiagramSequence> 
  <SequenceActor name="site" color="bg-sky-500" label="Tu sitio" positionX="-10" positionY="0" />
  <SequenceActor name="server" label="Tu servidor" positionX="200" positionY="0" />
  <SequenceActor name="webcheckout" color="bg-orange-500" label="Webcheckout" positionX="450" positionY="0" />
  <SequenceAction 
    from="site" 
    to="server" 
