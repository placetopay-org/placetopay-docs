...
<SequenceDiagram customView={{ height:"600px", x:130, y:27.2727 }}> 
  <SequenceActor name="site" color="bg-sky-500" label="Tu sitio" positionX="0" positionY="0" height="700px" />
  <Line id="line" label="Inicio" positionX="-100" positionY="35" width="800px" />
  <SequenceActor name="server" label="Tu servidor" positionX="200" positionY="0" height="700px" />
  <SequenceActor name="webcheckout" color="bg-orange-500" label="Webcheckout" positionX="500" positionY="0" height="700px" />
  <SequenceAction 
    name="process"
    from="site" 
    to="server" 
