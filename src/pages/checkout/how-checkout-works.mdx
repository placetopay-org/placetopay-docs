...
<SequenceDiagram customView={{ height:"600px", x:120, y:27.2727 }}> 
  <SequenceActor 
  id="site" 
  color="bg-sky-500" 
  label="Tu sitio" 
  ...
  <SequenceActor id="webcheckout" color="bg-orange-500" label="Webcheckout" positionX="550" positionY="0" height="700px" />
  <SequenceAction 
    id="process"
    from="site" 
    to="server" 
