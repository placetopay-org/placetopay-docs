...
Esto se puede lograr utilizando el método [API - Consultar sesión (getRequestInformation)](/checkout/api-reference/session#consultar-una-sesion).
...
- [Crear Sesión](/checkout/api-reference/session#crear-una-sesion)
- [Plugins y librerias](/checkout/plugins)
