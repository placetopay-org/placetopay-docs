...
<SequenceDiagram customView={{ height:"600px", x:200, y:27.2727 }}> 
  ...
  <SequenceActor name="server" label="Tu servidor" positionX="220" positionY="0" height="700px" />
  <SequenceActor name="webcheckout" color="bg-orange-500" label="Webcheckout" positionX="550" positionY="0" height="700px" />
  <SequenceAction 
    name="process"
    from="site" 
    to="server" 
