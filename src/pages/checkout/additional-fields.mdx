...
<Note>
Los datos con la propiedad `display: both, receipt, payment, receipt, approved`, se mostrarán en algún flujo de la interfaz.
</Note>

## Condiciones

- Se pueden agregar hasta 50 campos adicionales. Estos pueden enviarse en `fields`, `payment.fields`, o `subscription.fields`. Se validarán primero los campos en `fields` y se asignará el restante a `payment.fields` o `subscription.fields`.
- Hasta 255 caracteres en la proidad `value`
- Hasta 50 caracteres en la propidad `keywork`
