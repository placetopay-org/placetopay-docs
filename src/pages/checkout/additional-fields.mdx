...
Por ejemplo, es posible almacenar información propia de tu sistema, como el ID de la orden `cmsOrderId` o el ID del usuario que está realizando el proceso de pago `cmsUserId`.
...
- **Get Balance:** Es un servicio ofrecido por EVERTEC GROUP LLC. que controla y gestiona el saldo actual de los usuarios de un comercio.
...
Estructura que permite relacionar información relevante y controlar cuándo se mostrará en el proceso de cobro.
