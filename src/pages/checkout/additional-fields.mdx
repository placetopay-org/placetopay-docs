...
<Note>
El valor enviado con el keyword `CustomerAccountNumber` será utilizado en integraciones (Azure Functions - Online Response y Azure Functions Get Balance) y en reportes. Es crucial que el campo sea enviado con el keyword `CustomerAccountNumber`. Si se utiliza otro nombre, el valor no será procesado correctamente.
</Note>
