...
Si estás usando Lightbox para integrar PlacetoPay, asegúrate de actualizar el código que maneja la notificación para soportar ambos algoritmos. Revisa la sección de [Lightbox](/checkout/lightbox/) para más detalles sobre cómo manejar las notificaciones en este contexto.
