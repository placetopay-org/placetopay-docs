...
<Note>
Nota: La propiedad expiration es opcional. Si no se proporciona, el sistema asignará automáticamente un tiempo de expiración predeterminado de **1 hora** desde la creación de la sesión.
</Note>
