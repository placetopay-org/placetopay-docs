...
**Autenticación:** Para crear una sesión debes autenticarte con nuestra API, conoce los detalles en [Autenticación](/authentication)

**Localización:** Puedes elegir el idioma de la sesión haciendo uso de los parámetros del api, conoce los detalles en [Localización](/localization)
