...
## Crear una sesión {{ id: 'create-a-session', tag: 'POST', label: '/api/session' }}
...
```bash {{ title: 'Crear Sesión simple' }}
...
```
```bash {{ title: 'Crear Sesión de preautorización' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```
```bash {{ title: 'Crear sesión con pago mixto' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```
```bash {{ title: 'Crear sesión con impuestos' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```
```bash {{ title: 'Crear sesión con dispersión' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```
```bash {{ title: 'Crear sesión suscripción' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```
```bash {{ title: 'Crear sesión con recurrencia' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```
```bash {{ title: 'Crear sesión con modificadores' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```
```bash {{ title: 'Crear sesión con detalles' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```bash {{ title: 'Crear sesión con pago y subscripción' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "locale": "es_CO",
...
```bash {{ title: 'Sesión de autopago - Monto Fijo' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "auth": {
...
```bash {{ title: 'Sesión de autopago - Monto Total' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "auth": {
...
```bash {{ title: 'Sesión de autopago - Monto Mínimo' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "auth": {
...
```bash {{ title: 'Sesión de autopago - Monto Mínimo más extra' }}
curl -X "POST" https://checkout-test.placetopay.com/api/session \
  -H "Content-Type: application/json" \
  -d '{
    "auth": {
...
## Consultar una sesión {{ id: 'query-a-session', tag: 'POST', label: '/api/session/:requestId' }}
...
```
```json {{ title: '200: EXPIRADO PARCIALMENTE'}}
{
  "requestId": 1,
  "status": {
...
```
```json {{ title: '200: APROBADO PARCIALMENTE'}}
{
  "requestId": 1,
  "status": {
    "status": "APPROVED_PARTIAL",
...
## Cancelar una sesión {{ id: 'cancel-a-session', tag: 'POST', label: '/api/session/:requestId/cancel' }}
...
```
```json {{ title: '404: FALLIDO SESIÓN NO ENCONTRADA'}}
{
  "status": {
    "status": "FAILED",
...
```
```json {{ title: '400: FALLIDO ACCIÓN NO PERMITIDA'}}
{
  "status": {
    "status": "FAILED",
...
```
```json {{ title: '404: FALLIDO NO ENCONTRADO'}}
{
  "status": {
    "status": "FAILED",
    "reason": "NA",
