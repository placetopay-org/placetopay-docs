...
---
# Reembolsos
El endpoint de reembolsos permite revertir una transacción aprobada. Ver más en [Reembolsos](/checkout/reverse)

## Reembolsar pago {{ id: 'reverse-payment', tag: 'POST', label: '/api/reverse' }}
