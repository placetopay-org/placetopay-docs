export const description =
  'Conoce la política de cambios retrocompatibles en PlacetoPay API.'
...
**Ejemplo:** En el api `CreateRequest` se podría agregar un parámetro **opcional** `notificationUrl` para aquellos clientes integradores que quieren definir la url de notificación de esa sesión.
...
**Ejemplo:** En el api `GetRequestInformation` la respuesta puede ser modificada para incluir una nueva propiedad `cancelled` dentro de la propiedad `subscription`
