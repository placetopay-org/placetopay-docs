...
<Warning>Este cambio no aplica para el ambiente de producción en Chile. [Directorio de ambientes](/checkout/test-your-integration#directory-of-environments)</Warning>
