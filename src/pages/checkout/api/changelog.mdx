...
Configuración del número máximo permitido de dispersiones para los[pagos con dispersión](/checkout/create-session#dispersion-payment) en los endpoints `api/session` y `api/collect`. El límite máximo por defecto es de 3 dispersiones.
