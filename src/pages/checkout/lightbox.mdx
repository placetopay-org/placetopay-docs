...
<Note>Si estás utilizando Webcheckout desde un país diferente a Colombia, consulta la tabla de ambientes en [Pruebas de integración](/checkout/test-your-integration) para verificar los dominios correspondientes a tu región.   
