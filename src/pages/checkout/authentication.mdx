...
**nonce:** Valor arbirario que identifica a una petición cómo única.   
...
**tranKey:** Se genera en cada solicitud de forma programatica.   
Se genera con la siguiente formula `Base64(SHA-256(nonce + seed + secretKey))` esta formula debe ser traducida según el lenguaje de programación utilizado.
