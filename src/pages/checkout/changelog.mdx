...
- Removed support for creating recurring sessions and partial payments at the same time `/api/session`. Now, when trying to create a partial and recurring session, it responds with an exception.
