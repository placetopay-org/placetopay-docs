...
- Control para las propiedades `*.fields` en el request de creación de sesión `/api/session`. [Campos Adicionales]()

## `2.19.0` 2023-11-15

### Cambió:

- La fecha de `expiración` en la respuesta del endpint `Collect` se presenta ahora en formato ISO 8601.
