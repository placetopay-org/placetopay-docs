...
Además de las [integraciones del comercio](/onboarding/integrations), cada sitio puede tener las suyas. Viajan dentro del elemento del sitio, en `sites[].integrations`.
...
<Note type="warning">
  A diferencia de los [medios de pago del sitio](/onboarding/site-payment-methods), aquí el bloque `settings` se **reemplaza entero**. Una clave que estaba guardada y no reenvías **desaparece**. Para cambiar un solo valor, envía el bloque completo.
</Note>
...
<Note>
  Los [medios de pago del sitio](/onboarding/site-payment-methods) son la excepción: escribir uno **sí** marca el sitio como modificado.
</Note>
...
- [Integraciones del comercio](/onboarding/integrations)
