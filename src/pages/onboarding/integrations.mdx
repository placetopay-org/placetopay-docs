...
Una integración se direcciona **por su `type`**. Al escribir no hay identificadores numéricos: enviar `id` o `siteId` dentro de un elemento responde `422`, aunque [Consultar un comercio](/onboarding/show-merchant) publique un `id` por integración.
