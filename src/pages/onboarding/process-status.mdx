...
|---|---|---|
| `result.integrations` | Una entrada por integración escrita | [Integraciones](/onboarding/integrations) |
| `result.paymentMethods` | Una entrada por medio de pago escrito | [Medios de pago](/onboarding/payment-methods) |
| `result.sites` | Una entrada por sitio escrito | [Sitios](/onboarding/sites) |
...
El catálogo de códigos y qué hacer ante cada uno está en [Errores](/onboarding/errors).
...
- [Consultar un comercio](/onboarding/show-merchant) — leer el comercio que registró el proceso
- [Errores](/onboarding/errors)
- [Referencia de la API](/onboarding/api/reference/processes) — el contrato completo de la respuesta
