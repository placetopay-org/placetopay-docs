...
También lo devuelve [Consultar un comercio](/onboarding/show-merchant), en `paymentMethods[].id`, para todos los medios de pago del comercio, incluidos los que no se registraron desde esta API.
