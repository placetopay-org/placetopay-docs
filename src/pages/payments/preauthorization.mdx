export const description = 'Preautorización de pagos: retén fondos y ajusta o captura el monto posteriormente.'
...
- Las operaciones fallidas por factores externos con un estado de rechazo (como caídas del sistema) no afectan el flujo, y estos pasos pueden ser reintentados.
...
- Las tres están asociadas a una transacción principal de tipo **Preautorización**, que actúa como un resumen del flujo. Esta transacción principal se crea automáticamente cuando se realiza un **Check-in**.
...
- Un **Checkout** concluye el flujo, marcando la transacción de **Preautorización** como aprobada y asignando el monto final.
