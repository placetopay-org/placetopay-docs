...
- Total Cards Amount
- **Nota:** Los medios de pago: AMEX, VISA, MASTERCARD, DISCOVER, ATH, ATH MOVIL, ACH, EBT (Todos están actualmente habilitados)
...
<Note>En el caso del formato en PDF en este también se incluirían tanto las transacciones rechazadas como las aprobadas.</Note>
