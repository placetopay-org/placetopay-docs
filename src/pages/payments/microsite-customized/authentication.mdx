...
Soporte para dos tipos de autenticación del servicio al que se conecta. {{ className: 'lead' }}
...
Fecha ISO 8601 `(Y-m-d\TH:i:s\Z)` o `(Y-m-d\TH:i:sP)`  
Ejemplo: `seed = 2018-01-29T17:02:49-05:00`

Ten en cuenta que `nonce` y `seed` son generados, `login` y `trankey` son proporcionados por
el comercio, con esa información los datos a enviar deben ser:
