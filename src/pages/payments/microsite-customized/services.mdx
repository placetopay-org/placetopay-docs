...
```
El parámetro [mergePaymentMethods](/paymenys/microsite-customized/data-structures#fusion-de-metodos-de-pago-merge-payment-methods) dentro de la estructura ```options``` es el que permite definir el comportamiento esperado en este caso.
