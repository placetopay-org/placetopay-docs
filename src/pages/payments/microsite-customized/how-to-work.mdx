...
export const description = 'Flujo de integración del Micrositio Personalizado: consulta, bloqueo y asentamiento de facturas mediante servicios externos REST.'
...
1. **Autenticación:**  
   - Se soportan dos tipos de autenticación:  
     ...
     - Para obtener más información acerca de esto por favor dirigirse a la siguiente sección [Autenticación](/payments/microsite-customized/authentication).   
...
2. **Consultas de Facturas:**  
   ...
   - Para obtener más información acerca de esto por favor dirigirse a la siguiente sección [search](/payments/microsite-customized/services#busqueda-de-facturas).   
...
3. **Bloqueo y Liberación de Facturas:**  
   ...
   - Para obtener más información acerca de esto por favor dirigirse a la siguiente sección [hold](/payments/microsite-customized/services#bloqueo-y-liberacion-de-facturas).   
...
4. **Asentamiento de Pagos:**  
   ...
   - Para obtener más información acerca de esto por favor dirigirse a la siguiente sección [settle](/payments/microsite-customized/services#asentamiento-de-factura).   
...
5. **Manejo de Errores:**  
   ...
   - Para obtener más información acerca de esto por favor dirigirse a la siguiente sección [error](/payments/microsite-customized/error-handling).   
...
6. **Configuración de Métodos de Pago:**  
   ...
   - Para obtener más información acerca de esto por favor dirigirse a la siguiente sección [paymentMethod](/payments/microsite-customized/data-structures#configuracion-de-metodos-de-pago).   
...
<CenteredContainer>
  <ImageZoom
      ...
      alt="diagrama flujo micrositio personalizado"
...
El uso del hold es un método opcional pero recomendado por parte de la pasarela.

<CenteredContainer>
  <ImageZoom
      src="/customized_microsite_flow_hold.png"
      alt="diagrama flujo micrositio personalizado con hold"
      className="w-full h-auto shadow rounded-md my-0 transition-transform duration-300 ease-in-out cursor-pointer hover:scale-110 focus:scale-110"
  />
</CenteredContainer>
