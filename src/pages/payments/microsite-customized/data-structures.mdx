...
En este apartado podrás encontrar los tipos de datos y estructuras que puedes enviar al momento de realizar la integración con micrositio personalizado.
...
En la siguiente documentación se puede visualizar los tipos de documentos aceptados [Tipos de documentos](/checkout/document-types)