...
EBT admite dos formas de pago: **Regular** y **Cash**, que pueden utilizarse en la misma transacción.   
Para solicitar una sesión de pago con este medio, se deben enviar los siguientes parámetros en la solicitud:  
...
- **instrument.pin**: Código PinPad.
  - Las integraciones que deseen utilizar este tipo de cobro deben integrarse con el servicio [PinPad](/sdks/pinpad) para generar y validar el código.   
    Este código debe ser enviado en la solicitud dentro de la propiedad: 
