...
* En el detalle de la transacción, aparece una sección de “Transacciones relacionadas”, donde se encuentra el retorno referente

### Transacción de retorno

La transacción de retorno mantiene datos principales de la transacción principal como monto, moneda, identificador de terminal, etc, junto con algunas diferencias:
...
* Se agrega el código de retorno, el cúal específica la razón por la que fue ocurrio el retorno, ejemplo R01: Fondos insuficientes
...
ebus_ach_return_202410210746.csv
...
## Ebus ACH y Otros Procesos

Es importante tener claro que Ebus ACH, que maneja Placetopay en Puerto Rico, no es el mismo proceso que el ACH de Colombia. Aunque ambos operan bajo el sistema ACH, Ebus ACH en Puerto Rico sigue sus propios lineamientos y regulaciones, incluyendo el uso del archivo Nacha y códigos de retorno específicos para administrar las transacciones.