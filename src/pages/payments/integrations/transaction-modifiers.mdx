...
- **Porcentaje del Monto**: Porcentaje que se añadirá a la tarifa (comisión) calculada en base de la transacción original.
...
### ¿Cómo se calcula la tarifa (comisión) de una transacción?
...
### Ejemplos aplicación de modificador de transacción tipo tarifa
**Pagos básico**  
Los [pagos básicos](/checkout/create-session#basic-paymen) son modificados y se convierte en un [pago con dispersión](/checkout/create-session#dispersion-payment). Donde la dispersión número uno contiene el monto original de la petición del sitio, mientras que la dispersión número dos incluye los costos de la transacción más el impuesto correspondiente del modificador de transacción configurado.
