export const description =
  'Conoce el protocolo de autenticación de  Link de pagos API y cómo generar tu autenticación.';
  
# Autenticación

Para interactuar con la API de Link de pagos debes autenticar tus peticiones, de esta forma identificamos y validamos la información para que tus operaciones sean seguras. La API utiliza *Web Services Security UsernameToken Profile 1.1*. {{ className: 'lead' }}
