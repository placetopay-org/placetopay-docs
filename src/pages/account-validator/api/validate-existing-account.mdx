...
export const title = 'Validar cuenta Existente';
export const description = 'En esta página, encontrarás información sobre la API Validar Cuenta existente.'
...
<Row>
  <Col>
   ...
   <Col sticky>
      <CodeGroup title="Solicitud" tag="POST" label="/api/validate-existing-account">
      ```bash {{ title: 'cURL' }}
