...
Al pulsar confirmar el usuario verá la siguiente pantalla donde podrá seleccionar el tipo de cuenta. Si es una [**cuenta personal**](/account-validator/api#personal-account) o una [**cuenta comercial**](/account-validator/api#business-account):
