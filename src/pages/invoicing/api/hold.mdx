...
## Bloqueo o liberación de factura {{ id: 'hold-invoices', tag: 'POST', label: 'https://api-test.placetopay.com/rest/cash/invoice/hold' }}
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Bloquear o Liberar factura" tag="POST" label="/rest/cash/invoice/hold">
       ```bash {{ title: 'Bloquear factura' }}
