...
## Inscripción de creación de facturas {{ id: 'create-invoices', tag: 'POST', label: '/cash/invoice/create' }}
...
<Row>
  ...
  <Col sticky>
    <br />
  <CodeGroup title="Solicitud de creación de factura" tag="POST" label="/cash/invoice/create">
