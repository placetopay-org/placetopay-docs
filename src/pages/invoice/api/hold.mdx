...
## Bloqueo o liberación de factura {{ id: 'hold-invoices', tag: 'POST', label: '/hold' }}
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Solicitud" tag="POST" label="/hold">
      ```json {{ 'title': 'Bloquear factura' }}
      {
        "auth": {
