...
## Inscripción de creación de facturas {{ id: 'create-invoices', tag: 'POST', label: '/create' }}
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Solicitud" tag="POST" label="/create">
      ```json {{ 'title': 'Creación de facturas' }}
      {
        "auth": {
