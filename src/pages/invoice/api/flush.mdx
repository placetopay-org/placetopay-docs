...
## Eliminación masiva de facturas vencidas {{ id: 'flush-invoices', tag: 'POST', label: '/flush' }}
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Solicitud" tag="POST" label="/flush">
      ```json {{ 'title': 'Eliminar facturas vencidas' }}
      {
        "auth": {
