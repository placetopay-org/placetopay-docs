...
## Inscripción de búsqueda de factura {{ id: 'search-invoices', tag: 'POST', label: '/search' }}
...
<Row>
  ...
  <Col sticky>
    <br />
    <CodeGroup title="Solicitud" tag="POST" label="/search">
      ```json {{ 'title': 'Búsqueda de factura' }}
      {
        "auth": {
